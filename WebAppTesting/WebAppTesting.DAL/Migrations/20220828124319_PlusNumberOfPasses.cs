...
{
    public partial class PlusNumberOfPasses : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Testing_Grades_GradeID",
                        column: x => x.GradeID,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Testing_Subjects_SubjectID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tests_Testing_testingID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "xl4tir", "16079cf6877ceb45aea98ab7d4745e3076fc8c31288ca407d2529b99cf6d0db2", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Testing_GradeID",
                table: "Testing",
                column: "GradeID");

            migrationBuilder.CreateIndex(
                name: "IX_Testing_SubjectID",
                table: "Testing",
                column: "SubjectID");
